table 50301 "CRMAccountExt"
{
    ...
    fields
    {
        ...
        field(50001; new_Performance_ZipCode4; Text[13])
        {
            Caption = 'Post Code';
            DataClassification = ToBeClassified;
            ExternalName = 'new_performance_zipcode4';
            ExternalType = 'String';
        }
        field(50002; cat_BankName; Text[100])
        {
            Caption = 'Bank Name';
            DataClassification = ToBeClassified;
            ExternalName = 'cat_bankname';
            ExternalType = 'String';
        }
        field(50003; cat_BankAccountNumber; Text[16])
        {
            Caption = 'Bank Account Number';
            DataClassification = ToBeClassified;
            ExternalName = 'cat_bankaccountnumber';
            ExternalType = 'String';
        }
        field(50004; cat_NameonAccount; Text[100])
        {
            Caption = 'Name on Account';
            DataClassification = ToBeClassified;
            Description = 'Must match the Applicant''s original bank deposit slip to be supplied';
            ExternalName = 'cat_nameonaccount';
            ExternalType = 'String';
        }
        field(50005; new_Verified; Option)
        {
            Caption = 'Verified';
            Description = '';
            ExternalName = 'new_verified';
            ExternalType = 'Picklist';
            InitValue = VerificationPending;
            OptionCaption = 'On Hold,Rejected,Return to Draft,Seek more information,Verification Pending,Yes';
            OptionOrdinalValues = 260760001, 260760000, 260760002, 100000002, 100000001, 100000000;
            OptionMembers = OnHold,Rejected,ReturntoDraft,Seekmoreinformation,VerificationPending,Yes;
        }
    }
